      ...
      if (error) return (
            <AppShell>
                  <div className="flex flex-col items-center justify-center py-20 text-center">
                          ...
                          <h3 className="text-xl font-bold text-[#1A1D23] mb-2">Couldn't load your books</h3>h3>
                          <p className="text-[#4B5563] max-w-sm mb-2">{error}</p>p>
                          <p className="text-xs text-[#9CA3AF] mb-6">Check the browser console for details.</p>p>
                          <button
                  ...
                  return (
                        <AppShell>
                              <div className="mb-6">
                                      ...
                                      <p className="text-[#4B5563] text-lg mt-1">Happy reading!</p>p>
                              </div>div>
                          ...
                          {/* Action row */}
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                                      <Link
                                                ...
                                                <div>
                                                            <p className="font-bold text-base">Add a Book</p>p>
                                                            <p className="text-sm opacity-90">Upload your own PDF</p>p>
                                                </div>div>
                                      </Link>Link>
                                      ...
                                      <Link
                                                ...
                                                <div>
                                                            <p className="font-bold text-base">My Annotations</p>p>
                                                            <p className="text-sm opacity-90">See all your reading notes</p>p>
                                                </div>div>
                                      </Link>Link>
                              </div>div>
                          ...
                          {books.length === 0 ? (
                                  <div className="text-center py-16 bg-white rounded-2xl border border-[#F3F4F6]">
                                            ...
                                            <h3 className="text-xl font-bold text-[#1A1D23] mb-2">Your bookshelf is empty</h3>h3>
                                            <p className="text-[#4B5563] mb-6">Upload your own book or wait for your teacher to assign one.</p>p>
                                            <Link
                                                          to="/student/upload"
                                  ...
                                  <>
                                    ...
                                    {assignedBooks.length > 0 && (
                                                <section className="mb-8">
                                                              <h3 className="text-lg font-bold text-[#1A1D23] mb-4">Assigned by Teacher</h3>h3>
                                                              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                                    ...
                                    {myBooks.length > 0 && (
                                                <section>
                                                              <h3 className="text-lg font-bold text-[#1A1D23] mb-4">My Books</h3>h3>
                                                              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                                                                {myBooks.map((book) => (
                                                                    <BookCard
                                                                                          key={book.id}
                          ...
                          {confirmDelete && (
                                  <div
                                            ...
                                            <div
                                                        ...
                                                        >
                                                        <h3 className="font-bold text-xl text-[#1A1D23] mb-2">Delete this book?</h3>h3>
                                                        <p className="text-[#4B5563] mb-1 font-semibold">{confirmDelete.title}</p>p>
                        ...
                        return (
                              <div className="relative group bg-white rounded-2xl shadow-sm border border-[#F3F4F6] overflow-hidden hover:shadow-md hover:-translate-y-1 transition-all duration-200">
                                    <Link to={`/student/read/${book.id}`} className="block">
                                            ...
                                            <div className="p-3">
                                                      <h4 className="font-bold text-[#1A1D23] text-sm leading-tight line-clamp-2">{book.title}</h4>h4>
                                                      <p className="text-xs text-[#4B5563] mt-1">{book.author}</p>p>
                                              {book.readingLevel && (
