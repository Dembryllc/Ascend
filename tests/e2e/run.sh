...
FLOWS="${2:-tests/e2e/writing.e2e.mjs tests/e2e/register.e2e.mjs tests/e2e/pdftext.e2e.mjs tests/e2e/annotations.e2e.mjs tests/e2e/navigation.e2e.mjs tests/e2e/readaloud.e2e.mjs tests/e2e/removal.e2e.mjs}"
